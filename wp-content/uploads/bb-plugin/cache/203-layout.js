...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'57c3d790b078c',layout:'grid',pagination:'none',postSpacing:'25',postWidth:'360',matchHeight:1});});$(window).on('load',function(){$('.fl-node-57c3d790b078c .fl-post-grid').masonry('reloadItems');});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'57c3d7c38f17d',layout:'grid',pagination:'none',postSpacing:'25',postWidth:'360',matchHeight:1});});$(window).on('load',function(){$('.fl-node-57c3d7c38f17d .fl-post-grid').masonry('reloadItems');});})(jQuery);