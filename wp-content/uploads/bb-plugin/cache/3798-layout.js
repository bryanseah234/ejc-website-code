...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);YUI({'logExclude':{'yui':true}}).use('fl-slideshow',function(Y){if(null===Y.one('.fl-node-5901937a8d1ea .fl-bg-slideshow')){return;}
var oldSlideshow=Y.one('.fl-node-5901937a8d1ea .fl-bg-slideshow .fl-slideshow'),newSlideshow=new Y.FL.Slideshow({autoPlay:true,crop:true,loadingImageEnabled:false,randomize:false,responsiveThreshold:0,source:[{type:"urls",urls:[{thumbURL:"/wp-content/uploads/2017/04/OH2017_Slide1-150x150.png",largeURL:"/wp-content/uploads/2017/04/OH2017_Slide1-1024x439.png",x3largeURL:"/wp-content/uploads/2017/04/OH2017_Slide1.png",caption:""},{thumbURL:"/wp-content/uploads/2017/04/OH2017_Slide3-150x150.png",largeURL:"/wp-content/uploads/2017/04/OH2017_Slide3-1024x439.png",x3largeURL:"/wp-content/uploads/2017/04/OH2017_Slide3.png",caption:""},{thumbURL:"/wp-content/uploads/2017/04/OH2017_Slide2-150x150.png",largeURL:"/wp-content/uploads/2017/04/OH2017_Slide2-1024x439.png",x3largeURL:"/wp-content/uploads/2017/04/OH2017_Slide2.png",caption:""}]}],speed:3000,stretchy:true,stretchyType:'contain',transition:'fade',transitionDuration:1});if(oldSlideshow){oldSlideshow.remove(true);}
newSlideshow.render('.fl-node-5901937a8d1ea .fl-bg-slideshow');});(function($){$(function(){$('.fl-map').on('click',function(){$(this).find('iframe').css('pointer-events','auto');});});})(jQuery);