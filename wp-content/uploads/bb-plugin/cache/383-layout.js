...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'57be6e2c03df5',layout:'gallery',pagination:'none',postSpacing:'0',postWidth:'375',matchHeight:1});});})(jQuery);